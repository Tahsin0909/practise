...
import { decreaseQuantity, increaseQuantity, removeFromCart, toggleDrawer } from "./CartSlice";
    ...
    return (
        <Sheet open={isOpen} onOpenChange={() => dispatch(toggleDrawer())}>
            ...
            <SheetContent className="w-full sm:max-w-lg">
                ...
                <div className="flex flex-col justify-between  h-[calc(100vh-4.5rem)] ">
                    ...
                    {cart.length > 0 && (
                        <div className="space-y-4">
                            ...
                            <button className="w-full py-2 border rounded-lg bg-black text-white hover:bg-primary" onClick={() => handleCheckout(cart)}>
                                Checkout
                            </button>
                        </div>
                    )}
